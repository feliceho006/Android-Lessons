    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBackToCalculator.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                valueA = editTextSubValueOfA.getText().toString();
                valueB = editTextSubValueOfB.getText().toString();
                try{
                    Utils.checkInvalidInputs(valueA, "A");
                    Utils.checkInvalidInputs(valueB, "B");
                    ...
                    Toast.makeText(SubActivity.this, "Error Value: " + e, Toast.LENGTH_SHORT).show();
                }
